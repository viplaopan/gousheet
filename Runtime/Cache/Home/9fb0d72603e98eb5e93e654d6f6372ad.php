            ...
            <div class="spot_right">
                ...
                <div class="right_fb">
                    <div class="right_l">
                        ...
                        <div class="h9">
                            <input  type="button"  onclick="showdiv9();"  
                    style=" height:68px; width:68px; background:url(/Public/Home/images/right_jsj.png) no-repeat; float:right; color:#0e6eb8;cursor:pointer"/>
                    ...
                    <div class="right_r">
                        <div class="h10">
                            <input  type="button"  onclick="showdiv10();"  
                    style=" height:68px; width:68px; background:url(/Public/Home/images/right_yl.png)  no-repeat; float:right; color:#0e6eb8;cursor:pointer"/>
                            ...
                            <div id="show10">
                                ...
                                <div class="box_xg0">
                                    <div class="la_box"></div>
                                    <div class="la_inp">
                                        <input name="" type="radio" value=""  checked="checked" class="rad"/>
                                        <span class="sb1">算压力</span>
                                        <input name="" type="radio" value=""  class="rad"/>
                                        <span class="sb1">算壁厚</span>
                                    </div>
                                </div>
                                <div class="box_xg">
                                    <div class=" la_box">外径(mm)：</div>
...
<div class="clear"></div>
                        ...
                        <div id="headm">
                            <ul>
                                <li  id="pinzhongLi">
                                    <div class="dh">
                                        <a class="topa">
                                            <input type="text" class="box_ipt9" name="pinzhong" value="<?php echo I('get.pinzhong');?>" placeholder="15度弯头"></a>
                                        <ul>
                                            <li class="i_h0">
                                                <img src="/Public/Home/images/ggw_sanjiaoxing.png" />                    
                                                <span>管件</span>
                                            </li>
                                            ...
                                            <li class="i_h1">
                                                <a href="<?php echo U('Home/Guandao/molding_one',array('pinzhong'=>'翻边'));?>">翻边</a>
                                                <a href="<?php echo U('Home/Guandao/molding_one',array('pinzhong'=>'管帽'));?>">管帽</a>
                                                <a href="<?php echo U('Home/Guandao/molding_one',array('pinzhong'=>'金属软管'));?>">金属软管</a>
                                                <a href="<?php echo U('Home/Guandao/molding_one',array('pinzhong'=>'椭圆封头'));?>">椭圆封头</a>
                                                <a href="<?php echo U('Home/Guandao/molding_one',array('pinzhong'=>'锥形封头'));?>">锥形封头</a>
                                                <a href="<?php echo U('Home/Guandao/molding_one',array('pinzhong'=>'球形封头'));?>">球形封头</a>
                                                <a href="<?php echo U('Home/Guandao/molding_one',array('pinzhong'=>'球冠形封头'));?>">球冠形封头</a>
                                                <a href="<?php echo U('Home/Guandao/molding_one',array('pinzhong'=>'平底封头'));?>">平底封头</a>
                                                <a href="<?php echo U('Home/Guandao/molding_one',array('pinzhong'=>'碟形封头'));?>">碟形封头</a>
                                                <a href="<?php echo U('Home/Guandao/molding_one',array('pinzhong'=>'弓底封头'));?>">弓底封头</a>
                                                <a href="<?php echo U('Home/Guandao/molding_one',array('pinzhong'=>'浅形封头'));?>">浅形封头</a>
                                                <a href="<?php echo U('Home/Guandao/molding_one',array('pinzhong'=>'桶体旋边封头'));?>">桶体旋边封头</a>

                                            </li>
                                            <li class="i_hxian"></li>
                                            <li class="i_h2">
                                                <span class="clearbtn" parent-name="wantou">清除</span>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                <li id="caizhiLi">
                                    <div class="dh dh2">
                                        <a  class="topa">
                                            <input name="caizhi" type="text" class="box_ipt9" value="<?php echo I('get.caizhi');?>" placeholder="材质"></a>
                                        <ul>
                                            ...
                                            <li class="i_h4"></li>
                                            <li class="i_h5">
                                                <span class="clearbtn" parent-name="caizhi">清除</span>
                                            </li>
                                        </ul>
                                        <script type="text/javascript">
            $(function() {
                $('#caizhi a').click(function() {
                    ...
                    $("#caizhiLi").removeClass('show')
                                ...
                                <li>
                                    <div class="dh">
                                        <input name="guige" type="text"  class="box_ipt10" value="<?php echo I('get.guige');?>" placeholder="规格"></div>
                                </li>
                                <li id="gongyiLi">
                                    <div class="dh">
                                        <a class="topa">
                                            <input name="gongyi" type="text" class="box_ipt9" placeholder="工艺" value="<?php echo I('get.gongyi');?>"></a>
                                        <ul>
                                            <li class="i_h0">
                                                <img src="/Public/Home/images/ggw_sanjiaoxing.png" />                    
                                                <span>工艺</span>
                                            </li>
                                            <li class="i_h1" id="gongyi">
                                                <a>无缝对焊</a>
                                                <a>有缝对焊</a>
                                                <a>承插</a>
                                                <a>螺纹</a>
                                            ...
                                            <li class="i_hxian"></li>
                                            <li class="i_h2">
                                                <span class="clearbtn" parent-name="gongyi">清除</span>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
        ...
        $(function() {
            $('#gongyi a').click(function() {
                ...
                $("input[name='gongyi']").val($(this).html());
                $idstr = $(this).parent().attr('id');
                $(this).parent().removeClass('show');

                $("#gongyiLi").removeClass('show')
            })
                                ...
                                <li id="biaomianLi">
                                    <div class="dh dh2">
                                        <a  class="topa">
                                            <input name="biaomian" type="text" class="box_ipt7" value="<?php echo I('get.biaomian');?>" placeholder="表面"></a>
                                        <ul>
                                            ...
                                            <li class="i_h4"></li>
                                            <li class="i_h2">
                                                <span class="clearbtn" parent-name="biaomian">清除</span>
                                            </li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div class="dh">
                                        <input name="rzhi" type="text"  class="box_ipt8" value="<?php echo I('get.rzhi');?>" placeholder="R值">
                                    </div>
                                </li>
                                <li></li>
                                <li>
                                    <input name="" type="submit" class="box_bt" value="立即搜索">
                                </li>
                            </ul>
                        </div>
                        <script type=text/javascript>
            ...
            <div class="spit_sm">
                ...
                <div class="left_xx">
                    <div class="xx_title">
                        ...
                        <div class="box_h9">工艺</div>
                        <div class="box_h10">R值</div>
                        <div class="box_h11">表面</div>
                        <div class="box_h12">材质</div>
                        <div class="box_h13">规格(mm)</div>
                        <div class="box_h14">个数</div>
                        <div class="box_h15">公司名称</div>
                        <div class="box_h16">联系我们</div>
                        <div class="box_h17">仓库区</div>
                        <div class="box_h18">更新时间</div>
                    </div>
                    <?php if(is_array($lists)): $key = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><div class="xx_title1">
                            ...
                            <div class="box_h9"><?php echo ($vo["gongyi"]); ?></div>
                            <div class="box_h10"><?php echo ($vo["rzhi"]); ?></div>
                            <div class="box_h11"><?php echo ($vo["biaomian"]); ?></div>
                            <div class="box_h12"><?php echo ($vo["caizhi"]); ?></div>
                            <div class="box_h13"><?php echo ($vo["guige"]); ?></div>
                            <div class="box_h14"><?php echo ($vo["shuliang"]); ?></div>
                            <div class="box_h15"><?php echo ($vo['company']['name']); ?></div>
                ...
                <div class="xx_down">
                    <div class="xx_xia"><?php echo getPagination($totalPageCount,20);?></div>
                </div>
                <div class="clear"></div>
            </div>
            <div class="clear"></div>
