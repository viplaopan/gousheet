...
<!--立即搜索-->            
  ...
  <ul>
	  <li  id="pinzhongLi">
	  <div class="dh"><a class="topa"><input type="text" class="box_ipt9" name="pinzhong" value="" placeholder="15度弯头"></a>
	  <ul>
        ...
        <li class="i_hxian"></li>
        <li class="i_h2"><span class="clearbtn" parent-name="wantou">清除</span></li>
	  </ul>
	  </div>
	</li>
	<li id="caizhiLi">
	  <div class="dh dh2"><a  class="topa"><input name="caizhi" type="text" class="box_ipt9" value="" placeholder="材质"></a>
		  <ul>
           ...
           <li class="i_h4"></li>
           <li class="i_h5"><span class="clearbtn" parent-name="caizhi">清除</span></li>   
		  </ul>
		  <script type="text/javascript">
			$(function() {
	...
	<li>
    <div class="dh"><input name="" type="text"  class="box_ipt10" value="" placeholder="规格"></div>
	</li>
    <li id="gongyiLi">
	  <div class="dh"><a class="topa"><input name="gongyi" type="text" class="box_ipt9" placeholder="工艺" value=""></a>
	  <ul>
      	<li class="i_h0"><img src="/Public/Home/images/ggw_sanjiaoxing.png" /><span>工艺</span></li>
        ...
        <li class="i_hxian"></li>
        <li class="i_h2"><span class="clearbtn" parent-name="gongyi">清除</span></li>
	  </ul>
	  </div>
	</li>
    <script type="text/javascript">
      ...
      <li id="biaomianLi">
	  <div class="dh dh2"><a  class="topa"><input name="biaomian" type="text" class="box_ipt7" value="" placeholder="表面"></a>
		  <ul>
           ...
           <li class="i_h4"></li>
           <li class="i_h2"><span class="clearbtn" parent-name="biaomian">清除</span></li>  
		  </ul>
	  </div>
	</li>
    <script type="text/javascript">
    ...
    <li>
    <div class="dh"><input name="" type="text"  class="box_ipt8" value="" placeholder="R值"></div>
	</li>
    <li>
...
<!--信息-->  
     <div class="spit_sm">
       ...
       <div class="left_xx">
               ...
               <div class="xx_title1">
                	<div class="box_h9">无缝对焊</div>
                    <div class="box_h10">1.5</div>
                    <div class="box_h11"> 滚砂</div>
                    <div class="box_h12">S32750</div>
                    <div class="box_h13">159*5</div>
                    <div class="box_h14">1</div>
                    <div class="box_h15">温州大唐不锈钢 </div>    
                    <div id="title">                    
  						<ul>
   							<li>
    							<a href="#">点我联系</a>
    					<div class="div_ul">
                        		<ul class="h1">
                                        ...
                                        <li class="s5"></li>
                                        <li class="s6"> 联系人:朱呼呼（总经理）<div class="aa"><img src="/Public/Home/images/qq.jpg" /></div></li>
                                        <li class="s7"> 电话：057786988161</li>
                                        <li class="s7"> 手机：13806689377     <span>13706664496</span></li>
                                        <li class="s7"> 传真：057728906377</li>
                                        <li class="s7"> 经营模式：生产加工</li>
                                        <li class="s7"> 仓库：龙湾区镇标西路64号</li>
                                        <li class="s7">备注：青山料，低价甩卖</li>
                                </ul>
                    ...
                    <div class="box_h17">温州</div>
                    <div class="box_h18">1分钟前</div>
                </div>
...
<!--信息右边-->         
        <div class="right_c">
            ...
            <ul class="right_qg" style="margin-top:18px; padding-bottom:11px;">
            	<li class="right_title">
                	最活跃企业  <div class="right_ta">我要发布</div>
                </li>
                <li class="right_li"><span>温州鑫郎特种钢材有限公司</span></li>
                <li class="right_li"><span>安徽南特钢业有限公司</span></li>
                <li class="right_li"><span>温州联顺（顺益）不锈钢</span></li>
