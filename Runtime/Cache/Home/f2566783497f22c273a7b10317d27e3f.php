...
<div class="clear"></div>
				...
				<!--立即搜索-->
				<form action="/Home/Guandao/molding_one/pinzhong/%E7%BF%BB%E8%BE%B9.html?pinzhong=%E7%AE%A1%E5%B8%BD&caizhi=&guige=&biaomian=" method="get">
	...
	for(var i=0; i<lis.length; i++){
		...
		lis[i].onmouseout=function(){
			...
			<div class="spit_sm">
				...
				<div class="left_xx">
					<div class="xx_title">
	                    <div class="box_h19">表面</div>
	                    <div class="box_h20">材质</div>
	                    <div class="box_h21">规格(mm)</div>
	                    <div class="box_h22">个数</div>
	                    <div class="box_h23">公司名称</div>
	                    <div class="box_h24">联系我们</div>
	                    <div class="box_h25">仓库区</div>
	                    <div class="box_h26"> 更新时间</div>
	                </div>
