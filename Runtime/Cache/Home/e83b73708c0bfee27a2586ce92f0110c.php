	...
	<script>
		KindEditor.ready(function(K) {
			var editor1 = K.create('textarea[name="content"]', {
				cssPath: '/Public/Home/kindeditor/plugins/code/prettify.css',
				uploadJson: '/Public/Home/kindeditor/php/upload_json.php',
				fileManagerJson: '/Public/Home/kindeditor/php/file_manager_json.php',
	...
	<ul>
		...
		<li><a>退出登录</a></li>
				...
				<div class="right">
					...
					<form action="/index.php?s=/Home/Member/recruitEdit.html" method="post" name="reruit">
						<ul class="box_r">
							<li class="ii">
								<label>标题：</label><input name="title" value="<?php echo ($recruit["title"]); ?>" type="text" class="input" /><span class="panduan"></span>
							</li>
							<li class="ii">
								<label>信息内容：</label><textarea name="content" id="content" class="txt_con" style="width:650px; min-height:320px;"><?php echo ($recruit["content"]); ?></textarea>
							</li>
							<li class="ii">
								<input type="hidden" name="id" id="id" value="<?php echo ($recruit["id"]); ?>" />
		...
		$(function() {
			...
			function ajaxForm() {
				...
				function success(data) {
					if(data.status) {
						alert('提交成功');
						window.location.href = '<?php echo U('Member/recruit');?>'
					} else {
						alert('提交失败')
					}
				}
