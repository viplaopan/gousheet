...
<body>
    ...
    <div class="header">
        ...
        <!-- 用户栏 -->
        <div class="user-bar">
            <a href="javascript:;" class="region"><?php echo ($provs[$se_region]['region_name']); ?></a>
            <ul class="nav-list user-menu hidden" id="region-lists" ajax-url='<?php echo U('Admin/doRegion');?>'>
            	<?php if(is_array($provs)): $i = 0; $__LIST__ = $provs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li region_id="<?php echo ($vo["region_id"]); ?>"><a><?php echo ($vo["region_name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
            </ul>
        </div>
    </div>
    <!-- /头部 -->
